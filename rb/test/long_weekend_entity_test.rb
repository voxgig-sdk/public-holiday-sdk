...
class LongWeekendEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set PUBLIC_HOLIDAY_TEST_LONG_WEEKEND_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def long_weekend_basic_setup(extra)
  ...
  entid_env_raw = ENV["PUBLIC_HOLIDAY_TEST_LONG_WEEKEND_ENTID"]
