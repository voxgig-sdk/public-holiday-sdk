...
class AvailableCountryEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set PUBLICHOLIDAY_TEST_AVAILABLE_COUNTRY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def available_country_basic_setup(extra)
  ...
  entid_env_raw = ENV["PUBLICHOLIDAY_TEST_AVAILABLE_COUNTRY_ENTID"]
