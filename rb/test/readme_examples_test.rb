...
#      offline in seeded test mode (PublicHolidaySDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "PublicHoliday_sdk.rb")
  SDK_CLASS = "PublicHolidaySDK"
