...
class CountryInfoEntity
  ...
  def make
    opts = @_entopts.dup
    CountryInfoEntity.new(@_client, opts)
  end
  ...
  # @return [CountryInfo, Hash] the current CountryInfo data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CountryInfo fields)
  def match_get
  ...
  #
  # @param reqmatch [CountryInfoLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.CountryInfo.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [CountryInfo, Hash] the loaded CountryInfo; raises PublicHolidayError on failure
