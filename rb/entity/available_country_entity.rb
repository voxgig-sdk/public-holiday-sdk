...
class AvailableCountryEntity
  ...
  def make
    opts = @_entopts.dup
    AvailableCountryEntity.new(@_client, opts)
  end
  ...
  # @return [AvailableCountry, Hash] the current AvailableCountry data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AvailableCountry fields)
  def match_get
  ...
  #
  # @param reqmatch [AvailableCountryListMatch, Hash, nil] match filter (any subset of
  #   AvailableCountry fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<AvailableCountry>, Array] the matching AvailableCountry items; raises PublicHolidayError on failure
