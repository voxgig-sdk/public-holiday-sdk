...
class LongWeekendEntity
  ...
  def make
    opts = @_entopts.dup
    LongWeekendEntity.new(@_client, opts)
  end
  ...
  # @return [LongWeekend, Hash] the current LongWeekend data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of LongWeekend fields)
  def match_get
  ...
  #
  # @param reqmatch [LongWeekendListMatch, Hash, nil] match filter (any subset of
  #   LongWeekend fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<LongWeekend>, Array] the matching LongWeekend items; raises PublicHolidayError on failure
