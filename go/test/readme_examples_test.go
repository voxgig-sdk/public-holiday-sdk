...
const testSeed = `map[string]any{"entity": map[string]any{"available_country": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "country_info": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "long_weekend": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "public_holiday": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
