...
func (sdk *PublicHolidaySDK) OptionsMap() map[string]any {
...
func (sdk *PublicHolidaySDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *PublicHolidaySDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *PublicHolidaySDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PublicHolidaySDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *PublicHolidaySDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *PublicHolidaySDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("PublicHolidaySDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *PublicHolidaySDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PublicHolidaySDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("PublicHolidaySDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *PublicHolidaySDK {
	...
	sdk := NewPublicHolidaySDK(sdkopts)
	sdk.Mode = "test"
