...
type AvailableCountryEntity struct {
	name    string
...
func NewAvailableCountryEntity(client *core.PublicHolidaySDK, entopts map[string]any) *AvailableCountryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AvailableCountryEntity) GetName() string { return e.name }
...
func (e *AvailableCountryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AvailableCountryEntity) Deleted() bool {
	return e.deleted
}


func (e *AvailableCountryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAvailableCountryEntity(e.client, opts)
}

func (e *AvailableCountryEntity) Data(args ...any) any {
...
func (e *AvailableCountryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AvailableCountry; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AvailableCountryEntity) DataTyped(data ...AvailableCountry) AvailableCountry {
	if len(data) > 0 {
		return typedFrom[AvailableCountry](e.Data(asMap(data[0])))
	}
	return typedFrom[AvailableCountry](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AvailableCountry (all fields
// optional at the wire level).
func (e *AvailableCountryEntity) MatchTyped(match ...AvailableCountry) AvailableCountry {
	if len(match) > 0 {
		return typedFrom[AvailableCountry](e.Match(asMap(match[0])))
	}
	return typedFrom[AvailableCountry](e.Match())
}
...
func (e *AvailableCountryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AvailableCountryEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AvailableCountryEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AvailableCountryListMatch and returns []AvailableCountry. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AvailableCountryEntity) ListTyped(reqmatch AvailableCountryListMatch, ctrl map[string]any) ([]AvailableCountry, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[AvailableCountry](res), nil
}



func (e *AvailableCountryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AvailableCountryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AvailableCountryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AvailableCountryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
