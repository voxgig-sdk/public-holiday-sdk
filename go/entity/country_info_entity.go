...
func NewCountryInfoEntity(client *core.PublicHolidaySDK, entopts map[string]any) *CountryInfoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CountryInfoEntity) GetName() string { return e.name }
...
func (e *CountryInfoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CountryInfoEntity) Deleted() bool {
	return e.deleted
}


func (e *CountryInfoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCountryInfoEntity(e.client, opts)
}

func (e *CountryInfoEntity) Data(args ...any) any {
...
func (e *CountryInfoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CountryInfo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CountryInfoEntity) DataTyped(data ...CountryInfo) CountryInfo {
	if len(data) > 0 {
		return typedFrom[CountryInfo](e.Data(asMap(data[0])))
	}
	return typedFrom[CountryInfo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CountryInfo (all fields
// optional at the wire level).
func (e *CountryInfoEntity) MatchTyped(match ...CountryInfo) CountryInfo {
	if len(match) > 0 {
		return typedFrom[CountryInfo](e.Match(asMap(match[0])))
	}
	return typedFrom[CountryInfo](e.Match())
}
...
func (e *CountryInfoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CountryInfoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CountryInfoLoadMatch and returns an CountryInfo. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CountryInfoEntity) LoadTyped(reqmatch CountryInfoLoadMatch, ctrl map[string]any) (CountryInfo, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CountryInfo{}, err
	}
	return typedFrom[CountryInfo](res), nil
}



func (e *CountryInfoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CountryInfoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CountryInfoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CountryInfoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CountryInfoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
