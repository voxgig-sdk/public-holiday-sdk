...
type PublicHolidayEntity struct {
	name    string
...
func NewPublicHolidayEntity(client *core.PublicHolidaySDK, entopts map[string]any) *PublicHolidayEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PublicHolidayEntity) GetName() string { return e.name }
...
func (e *PublicHolidayEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PublicHolidayEntity) Deleted() bool {
	return e.deleted
}


func (e *PublicHolidayEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPublicHolidayEntity(e.client, opts)
}

func (e *PublicHolidayEntity) Data(args ...any) any {
...
func (e *PublicHolidayEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PublicHoliday; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PublicHolidayEntity) DataTyped(data ...PublicHoliday) PublicHoliday {
	if len(data) > 0 {
		return typedFrom[PublicHoliday](e.Data(asMap(data[0])))
	}
	return typedFrom[PublicHoliday](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PublicHoliday (all fields
// optional at the wire level).
func (e *PublicHolidayEntity) MatchTyped(match ...PublicHoliday) PublicHoliday {
	if len(match) > 0 {
		return typedFrom[PublicHoliday](e.Match(asMap(match[0])))
	}
	return typedFrom[PublicHoliday](e.Match())
}
...
func (e *PublicHolidayEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PublicHolidayEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PublicHolidayLoadMatch and returns an PublicHoliday. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PublicHolidayEntity) LoadTyped(reqmatch PublicHolidayLoadMatch, ctrl map[string]any) (PublicHoliday, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PublicHoliday{}, err
	}
	return typedFrom[PublicHoliday](res), nil
}




func (e *PublicHolidayEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PublicHolidayListMatch and returns []PublicHoliday. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PublicHolidayEntity) ListTyped(reqmatch PublicHolidayListMatch, ctrl map[string]any) ([]PublicHoliday, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PublicHoliday](res), nil
}



func (e *PublicHolidayEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PublicHolidayEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PublicHolidayEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PublicHolidayEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
