...
// instead of `sdk.NewPublicHolidaySDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *PublicHolidaySDK  { return NewPublicHolidaySDK(nil) }
func Test() *PublicHolidaySDK { return TestSDK(nil, nil) }
