...
|---|---|---|
| `ts/` | @voxgig-sdk/public-holiday-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/public-holiday-sdk \
      --repository voxgig-sdk/public-holiday-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/public-holiday-sdk` shows it, and
`npm trust revoke @voxgig-sdk/public-holiday-sdk --id=<id>` removes it.
