...
// PublicHoliday SDK utility: graphql
//
...
class PublicHolidayGraphql
{
    ...
    // equivalent.
    public static function body(PublicHolidayContext $ctx): mixed
    {
    ...
    public static function errors(PublicHolidayContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
