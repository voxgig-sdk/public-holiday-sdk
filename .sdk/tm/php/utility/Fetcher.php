...
// PublicHoliday SDK utility: fetcher
...
class PublicHolidayFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PublicHolidaySDK/1.0)';
    ...
    public static function call(PublicHolidayContext $ctx, string $fullurl, array $fetchdef): array
    {
