...
// PublicHoliday SDK proxy feature
...
class PublicHolidayProxyFeature extends PublicHolidayBaseFeature
{
    ...
    public function init(PublicHolidayContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PublicHolidayContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
