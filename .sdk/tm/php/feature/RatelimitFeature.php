...
// PublicHoliday SDK ratelimit feature
...
class PublicHolidayRatelimitFeature extends PublicHolidayBaseFeature
{
    ...
    private function _acquire(PublicHolidayContext $ctx): void
    {
    ...
    private function _track(PublicHolidayContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
