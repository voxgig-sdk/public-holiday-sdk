...
// PublicHoliday SDK timeout feature
...
class PublicHolidayTimeoutFeature extends PublicHolidayBaseFeature
{
    ...
    private function _with_timeout(PublicHolidayContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PublicHolidayContext $_ctx, float $ms): void
    {
        $client = $this->client;
