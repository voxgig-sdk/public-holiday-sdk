...
// PublicHoliday SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = PublicHolidayOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(PublicHolidayOmni::structfix($now, Struct::undef()))
                        !== json_encode(PublicHolidayOmni::structfix($val, Struct::undef()))) {
