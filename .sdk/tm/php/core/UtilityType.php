...
// PublicHoliday SDK utility type

class PublicHolidayUtility
{
    ...
    public static function copy(PublicHolidayUtility $src): PublicHolidayUtility
    {
        $u = new PublicHolidayUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
