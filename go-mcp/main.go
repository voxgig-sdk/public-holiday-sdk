// Command PublicHoliday-mcp is an MCP server exposing the PublicHoliday
// SDK as MCP tools.
//
// Two tools are registered:
//
//	PublicHoliday_list  — list records of an entity
//	PublicHoliday_load  — load a single record of an entity
//
