...
// PublicHoliday SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class PublicHolidayTransformResponse
{
    public static function call(PublicHolidayContext $ctx): mixed
    {
        ...
        $transform = PublicHolidayHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
