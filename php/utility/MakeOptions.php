...
// PublicHoliday SDK utility: make_options

class PublicHolidayMakeOptions
{
    ...
    public static function call(PublicHolidayContext $ctx): array
    {
        ...
        //
        // `PublicHolidaySchema::optspec()` is built from the model:
        ...
        $optspec = PublicHolidaySchema::optspec();
