...
class LongWeekendEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set PUBLICHOLIDAY_TEST_LONG_WEEKEND_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function long_weekend_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("PUBLICHOLIDAY_TEST_LONG_WEEKEND_ENTID");
