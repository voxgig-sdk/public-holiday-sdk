...
// PublicHoliday SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PublicHolidaySDK::test)
...
{
    private const SDK_CLASS = 'PublicHolidaySDK';
    ...
    private const SDK_BASE = 'publicholiday_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../publicholiday_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
