...
// PublicHoliday SDK CountryInfo entity
...
class CountryInfoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CountryInfoEntity($this->_client, $opts);
    }

    /**
     * @param CountryInfo|array $args CountryInfo data (assoc-array) to store.
     */
    ...
    /**
     * @return CountryInfo|array The current CountryInfo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CountryInfo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CountryInfo fields).
     */
    ...
    /**
     * Load a single CountryInfo.
     *
     * @param CountryInfoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CountryInfoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CountryInfo|array The loaded CountryInfo as an assoc-array at the
