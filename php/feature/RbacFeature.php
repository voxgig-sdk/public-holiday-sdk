...
// PublicHoliday SDK rbac feature
...
class PublicHolidayRbacFeature extends PublicHolidayBaseFeature
{
    ...
    private function _required(PublicHolidayContext $ctx): ?string
    {
    ...
    private function _reject(PublicHolidayContext $ctx, string $required): void
    {
    ...
    private function _track(PublicHolidayContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
