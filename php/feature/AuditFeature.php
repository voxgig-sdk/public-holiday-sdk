...
// PublicHoliday SDK audit feature
...
class PublicHolidayAuditFeature extends PublicHolidayBaseFeature
{
    ...
    private function _emit(PublicHolidayContext $ctx, string $outcome): void
    {
