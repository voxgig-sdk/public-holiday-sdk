...
// PublicHoliday SDK netsim feature
...
class PublicHolidayNetsimFeature extends PublicHolidayBaseFeature
{
    ...
    private function _simulate(PublicHolidayContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PublicHolidayContext $ctx, array $applied): void
    {
        $client = $this->client;
