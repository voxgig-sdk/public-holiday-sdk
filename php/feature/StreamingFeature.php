...
// PublicHoliday SDK streaming feature
...
class PublicHolidayStreamingFeature extends PublicHolidayBaseFeature
{
    ...
    private function _iterate(PublicHolidayResult $result): \Generator
    {
    ...
    private function _streamable(PublicHolidayContext $ctx): bool
    {
