...
// PublicHoliday SDK metrics feature
...
class PublicHolidayMetricsFeature extends PublicHolidayBaseFeature
{
    ...
    private function _record(PublicHolidayContext $ctx, bool $ok): void
    {
