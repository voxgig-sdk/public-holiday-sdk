...
// PublicHoliday SDK clienttrack feature
...
class PublicHolidayClienttrackFeature extends PublicHolidayBaseFeature
{
    ...
    public function PostConstruct(PublicHolidayContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'PublicHoliday-SDK';
