...
// PublicHoliday SDK cache feature
...
class PublicHolidayCacheFeature extends PublicHolidayBaseFeature
{
    ...
    private function _through(PublicHolidayContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
