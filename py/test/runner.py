...
class PublicHolidayTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PublicHolidayTestRunner.getenv("PUBLICHOLIDAY_TEST_LIVE")
        override = PublicHolidayTestRunner.getenv("PUBLICHOLIDAY_TEST_OVERRIDE")
        ...
        explain = PublicHolidayTestRunner.getenv("PUBLICHOLIDAY_TEST_EXPLAIN")
