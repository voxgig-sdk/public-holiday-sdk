# PublicHoliday SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PublicHolidaySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PublicHolidaySDK(...) and PublicHolidaySDK.test(...) become
#      PublicHolidaySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "publicholiday_sdk"
_SDK_CLASS = "PublicHolidaySDK"
...
_ENTITIES = {
    "AvailableCountry": "available_country",
