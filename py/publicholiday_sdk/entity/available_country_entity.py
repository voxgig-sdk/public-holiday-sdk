...
class AvailableCountryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AvailableCountryEntity(self._client, opts)
    ...
    def data_get(self) -> AvailableCountry:
    ...
    def match_get(self) -> AvailableCountry:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AvailableCountry]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AvailableCountry().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
