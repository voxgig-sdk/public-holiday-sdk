...
from publicholiday_sdk.utility import register

# Load features
from publicholiday_sdk.feature.base_feature import PublicHolidayBaseFeature
from publicholiday_sdk.features import _has_feature, _make_feature
...
class PublicHolidaySDK:
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PublicHolidaySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def AvailableCountry(self, data=None) -> "AvailableCountryEntity":
        ...
        from publicholiday_sdk.entity.available_country_entity import AvailableCountryEntity
    ...
    def CountryInfo(self, data=None) -> "CountryInfoEntity":
        ...
        from publicholiday_sdk.entity.country_info_entity import CountryInfoEntity
    ...
    def LongWeekend(self, data=None) -> "LongWeekendEntity":
        ...
        from publicholiday_sdk.entity.long_weekend_entity import LongWeekendEntity
    ...
    def PublicHoliday(self, data=None) -> "PublicHolidayEntity":
        ...
        from publicholiday_sdk.entity.public_holiday_entity import PublicHolidayEntity
