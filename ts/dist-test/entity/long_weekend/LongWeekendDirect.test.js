...
(0, node_test_1.describe)('LongWeekendDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-long_weekend', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-long_weekend', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PUBLIC_HOLIDAY_TEST_LONG_WEEKEND_ENTID'];
...
//# sourceMappingURL=LongWeekendDirect.test.js.map