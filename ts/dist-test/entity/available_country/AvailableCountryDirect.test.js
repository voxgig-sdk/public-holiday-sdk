...
(0, node_test_1.describe)('AvailableCountryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-available_country', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-available_country', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PUBLIC_HOLIDAY_TEST_AVAILABLE_COUNTRY_ENTID'];
...
//# sourceMappingURL=AvailableCountryDirect.test.js.map