...
(0, node_test_1.describe)('AvailableCountryEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/available_country/AvailableCountryTestData.json');
    ...
    let idmap = transform(['available_country01', 'available_country02', 'available_country03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AvailableCountryEntity.test.js.map