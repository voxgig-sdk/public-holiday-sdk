...
(0, node_test_1.describe)('PublicHolidayDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.PublicHolidaySDK({
    ...
    (0, node_test_1.test)('direct-load-public_holiday', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-public_holiday', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-public_holiday', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-public_holiday', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["country_code01", "year01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.PUBLIC_HOLIDAY_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.PublicHolidaySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['PUBLIC_HOLIDAY_TEST_PUBLIC_HOLIDAY_ENTID'];
    ...
    const client = new __1.PublicHolidaySDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PublicHolidayDirect.test.js.map