...
(0, node_test_1.describe)('CountryInfoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-country_info', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-country_info', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PUBLIC_HOLIDAY_TEST_COUNTRY_INFO_ENTID'];
...
//# sourceMappingURL=CountryInfoDirect.test.js.map