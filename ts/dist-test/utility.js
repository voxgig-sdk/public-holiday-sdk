...
function envOverride(m) {
    if ('TRUE' === process.env.PUBLIC_HOLIDAY_TEST_LIVE ||
        'TRUE' === process.env.PUBLIC_HOLIDAY_TEST_OVERRIDE) {
    ...
    m.PUBLIC_HOLIDAY_TEST_EXPLAIN = process.env.PUBLIC_HOLIDAY_TEST_EXPLAIN || m.PUBLIC_HOLIDAY_TEST_EXPLAIN;
    return m;
}
