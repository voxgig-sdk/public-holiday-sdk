# PublicHoliday TypeScript SDK



The TypeScript SDK for the PublicHoliday API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.AvailableCountry()` — each with a small set of operations (`list`, `load`)
...
| `tester(testopts?, sdkopts?)` | `PublicHolidaySDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `PublicHolidaySDK.test(testopts?, sdkopts?)` | `PublicHolidaySDK` | Create a test-mode client. |
...
| `client` | `client(): PublicHolidaySDK` | Return the parent SDK client. |
...
public-holiday/
├── src/
│   ├── PublicHolidaySDK.ts        # Main SDK class
