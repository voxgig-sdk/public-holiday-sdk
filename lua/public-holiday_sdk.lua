...
local PublicHolidaySDK = {}
PublicHolidaySDK.__index = PublicHolidaySDK
...
PublicHolidaySDK._make_feature = _make_feature


function PublicHolidaySDK.new(options)
  local self = setmetatable({}, PublicHolidaySDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function PublicHolidaySDK:options_map()
...
function PublicHolidaySDK:get_utility()
  return Utility.copy(self._utility)
end


function PublicHolidaySDK:get_root_ctx()
  return self._rootctx
end


function PublicHolidaySDK:prepare(fetchargs)
...
function PublicHolidaySDK:direct(fetchargs)
...
-- by passing it.
function PublicHolidaySDK:_raw_request(fetchargs)
  local utility = self._utility
...
function PublicHolidaySDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "PublicHolidaySDK: graphql: " .. msg
    res.graphql = errors
  end
...
function PublicHolidaySDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = PublicHolidaySDK.new(sdkopts)
  sdk.mode = "test"
