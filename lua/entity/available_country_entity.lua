...
local AvailableCountryEntity = {}
AvailableCountryEntity.__index = AvailableCountryEntity


function AvailableCountryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AvailableCountryEntity)
  self._name = "available_country"
  self._client = client
...
function AvailableCountryEntity:get_name()
  return self._name
end


function AvailableCountryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AvailableCountryEntity.new(self._client, opts)
end
...
function AvailableCountryEntity:mark_deleted()
  self._deleted = true
end


function AvailableCountryEntity:deleted()
  return true == self._deleted
end


function AvailableCountryEntity:data_set(args)
  if args ~= nil then
...
function AvailableCountryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AvailableCountryEntity:match_set(args)
  if args ~= nil then
...
function AvailableCountryEntity:match_get()
...
function AvailableCountryEntity:stream(action, args, callopts)
...
---@param reqmatch AvailableCountryListMatch
---@param ctrl? table
---@return AvailableCountry[]
---@return string? err
function AvailableCountryEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function AvailableCountryEntity:_run_op(ctx, post_done)
  local utility = self._utility
