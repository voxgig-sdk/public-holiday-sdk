...
local PublicHolidayEntity = {}
PublicHolidayEntity.__index = PublicHolidayEntity


function PublicHolidayEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PublicHolidayEntity)
  self._name = "public_holiday"
  self._client = client
...
function PublicHolidayEntity:get_name()
  return self._name
end


function PublicHolidayEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PublicHolidayEntity.new(self._client, opts)
end
...
function PublicHolidayEntity:mark_deleted()
  self._deleted = true
end


function PublicHolidayEntity:deleted()
  return true == self._deleted
end


function PublicHolidayEntity:data_set(args)
  if args ~= nil then
...
function PublicHolidayEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PublicHolidayEntity:match_set(args)
  if args ~= nil then
...
function PublicHolidayEntity:match_get()
...
function PublicHolidayEntity:stream(action, args, callopts)
...
function PublicHolidayEntity:_run_op(ctx, post_done)
  local utility = self._utility
