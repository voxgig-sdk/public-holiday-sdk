-- PublicHoliday SDK LongWeekend entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local LongWeekendEntity = {}
LongWeekendEntity.__index = LongWeekendEntity


function LongWeekendEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LongWeekendEntity)
  self._name = "long_weekend"
  self._client = client
...
function LongWeekendEntity:get_name()
  return self._name
end


function LongWeekendEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LongWeekendEntity.new(self._client, opts)
end
...
function LongWeekendEntity:mark_deleted()
  self._deleted = true
end


function LongWeekendEntity:deleted()
  return true == self._deleted
end


function LongWeekendEntity:data_set(args)
  if args ~= nil then
...
function LongWeekendEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LongWeekendEntity:match_set(args)
  if args ~= nil then
...
function LongWeekendEntity:match_get()
...
function LongWeekendEntity:stream(action, args, callopts)
...
function LongWeekendEntity:_run_op(ctx, post_done)
  local utility = self._utility
