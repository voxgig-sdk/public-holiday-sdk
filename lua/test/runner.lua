...
function runner.env_override(m)
  local live = runner.getenv("PUBLICHOLIDAY_TEST_LIVE")
  local override = runner.getenv("PUBLICHOLIDAY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PUBLICHOLIDAY_TEST_EXPLAIN")
