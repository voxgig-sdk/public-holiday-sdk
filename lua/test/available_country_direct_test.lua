...
describe("AvailableCountryDirect", function()
  it("should direct-list-available_country", function()
    local setup = available_country_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-available_country", setup.live and "live" or "unit")
...
function available_country_direct_setup(mockres)
