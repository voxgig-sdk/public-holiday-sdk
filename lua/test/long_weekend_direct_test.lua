...
describe("LongWeekendDirect", function()
  it("should direct-list-long_weekend", function()
    local setup = long_weekend_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-long_weekend", setup.live and "live" or "unit")
