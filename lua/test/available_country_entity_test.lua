...
describe("AvailableCountryEntity", function()
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:AvailableCountry(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:AvailableCountry(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set PUBLIC_HOLIDAY_TEST_AVAILABLE_COUNTRY_ENTID JSON to run live")
      return
    end
...
function available_country_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("PUBLIC_HOLIDAY_TEST_AVAILABLE_COUNTRY_ENTID")
