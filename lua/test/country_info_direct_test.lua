...
describe("CountryInfoDirect", function()
  it("should direct-load-country_info", function()
    local setup = country_info_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-country_info", setup.live and "live" or "unit")
...
function country_info_direct_setup(mockres)
