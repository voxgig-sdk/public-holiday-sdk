...
local SDK_MODULE = "public-holiday_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["available_country"] = { ["test01"] = { id = "test01" } }, ["country_info"] = { ["test01"] = { id = "test01" } }, ["long_weekend"] = { ["test01"] = { id = "test01" } }, ["public_holiday"] = { ["test01"] = { id = "test01" } } } }'
