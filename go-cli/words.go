...
func registerSDKWords(r *eng.Registry, client *sdk.PublicHolidaySDK) {
...
func runOp(client *sdk.PublicHolidaySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
