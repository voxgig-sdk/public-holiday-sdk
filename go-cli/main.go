// Command PublicHoliday-cli is a CLI + REPL for the PublicHoliday SDK,
...
const prompt = "public-holiday"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "available_country country_info long_weekend public_holiday"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      PUBLIC_HOLIDAY_APIKEY (api key), PUBLIC_HOLIDAY_BASE (base url override)")
