...
AQL-driven CLI and REPL for the PublicHoliday SDK. Positional arguments are
...
./public-holiday-cli load 1 available_country
./public-holiday-cli load '{id:1}' available_country
