...
An API for public holiday data.

Learn more about Public Holiday API at [date.nager.at](https://date.nager.at).
...
This SDK exposes the API as a small set of **semantic entities** — AvailableCountry, CountryInfo, LongWeekend and PublicHoliday — that you
...
const items = await client.AvailableCountry().list()
```
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/public-holiday-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/public-holiday-sdk/tags) |
| Python | `voxgig-sdk-public-holiday` | publish pending — [install from git tag](https://github.com/voxgig-sdk/public-holiday-sdk/tags) |
| PHP | `voxgig-sdk/public-holiday` | publish pending — [install from git tag](https://github.com/voxgig-sdk/public-holiday-sdk/tags) |
| Golang | `github.com/voxgig-sdk/public-holiday-sdk/go` | `go get github.com/voxgig-sdk/public-holiday-sdk/go@latest` |
| Ruby | `voxgig-sdk-public-holiday` | publish pending — [install from git tag](https://github.com/voxgig-sdk/public-holiday-sdk/tags) |
| Lua | `voxgig-sdk-public-holiday` | publish pending — [install from git tag](https://github.com/voxgig-sdk/public-holiday-sdk/tags) |
| Go CLI | `github.com/voxgig-sdk/public-holiday-sdk/go-cli` | `go install github.com/voxgig-sdk/public-holiday-sdk/go-cli/cmd/public-holiday@latest` |
| Go MCP server | `github.com/voxgig-sdk/public-holiday-sdk/go-mcp` | `go get github.com/voxgig-sdk/public-holiday-sdk/go-mcp@latest` |
...
// Load a specific publicholiday (returns a PublicHoliday)
...
$availablecountrys = $client->AvailableCountry()->list();
print_r(array_map(fn($item) => $item->data_get(), $availablecountrys));
```
...
// Load a specific publicholiday
publicHoliday, err := client.PublicHoliday(nil).Load(
    map[string]any{"country_code": "example_country_code"}, nil,
)
if err != nil {
    panic(err)
}
fmt.Println(publicHoliday)
```
